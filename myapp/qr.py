...
headingLabel = Label(headingFrame, text="Generate QR Code with DataFlair", bg='wheat', font=('Times',20,'bold'))
headingLabel.place(relx=0,rely=0, relwidth=1, relheight=1)

        #Taking the input of the text or URL to get QR code
Frame1 = Frame(wn,bg="coral")
Frame1.place(relx=0.1,rely=0.15,relwidth=0.7,relheight=0.3)

label1 = Label(Frame1,text="Enter the text/URL: ",bg="coral",fg='black',font=('monospace',13,'bold'))
...
Frame2 = Frame(wn,bg="coral")
Frame2.place(relx=0.1,rely=0.35,relwidth=0.7,relheight=0.3)

label2 = Label(Frame2,text="Enter the location to save the QR Code: ",bg="coral",fg='black',font=('monospace',13,'bold'))
...
Frame3 = Frame(wn,bg="coral")
Frame3.place(relx=0.1,rely=0.55,relwidth=0.7,relheight=0.3)

label3 = Label(Frame3,text="Enter the name of the QR Code: ",bg="coral",fg='black',font=('monospace',13,'bold'))
...
Frame4 = Frame(wn,bg="coral")
Frame4.place(relx=0.1,rely=0.75,relwidth=0.7,relheight=0.2)

label4 = Label(Frame4,text="Enter the size from 1 to 40 with 1 being 21x21: ",bg="coral",fg='black',font=('monospace',13,'bold'))
